...
public class relativefreq2 {
    ...
    public static void main(String[] args) throws IOException,InterruptedException,ClassNotFoundException {
        ...
        job.setJobName("Relative_Frequencies_2");
...
class PairsRelativeOccurrenceMapper extends Mapper<LongWritable, Text, wordpair2, IntWritable> {
...
class PairsRelativeOccurrenceReducer extends Reducer<wordpair2, IntWritable, wordpair2, DoubleWritable> {
